...
export const getBranchById = async (req, res) => {
  const branch = await branchService.getBranchById(req.validated.params.id);
  ApiResponse.ok(res, "Branch retrieved successfully", branch);
};
export const createBranch = async (req, res) => {
  const branch = await branchService.createBranch(req.validated.body);
...
export const deleteBranch = async (req, res) => {
  await branchService.deleteBranch(req.validated.params.id);
